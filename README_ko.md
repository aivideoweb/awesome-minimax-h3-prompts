...
**프로젝트에 기여：** [프롬프트 제안](https://github.com/aivideoweb/awesome-minimax-h3-prompts/issues/new?template=prompt-proposal.yml) · [문서 개선](https://github.com/aivideoweb/awesome-minimax-h3-prompts/issues/new?template=documentation.yml) · [풀 리퀘스트 만들기](https://github.com/aivideoweb/awesome-minimax-h3-prompts/pulls)
...
각 그룹 끝의 “비슷한 기법 연습하기” 링크는 이 라이브러리의 독립적인 프롬프트와 템플릿으로 연결되며, 소개된 영상에 사용된 원본 프롬프트가 아닙니다. 각 영상의 “작성자 프롬프트” 링크는 작성자의 원문으로 연결됩니다. 필요한 참고 자료와 도구의 지원 기능을 먼저 확인하세요.
...
| 헤드폰 광고: 질감에서 분해 장면까지 | 파란 스튜디오의 패션 영상 | 스킨케어 광고: 밤부터 아침까지의 연속성 |
|---|---|---|
...
| 캐릭터 등장: 세부에서 전신으로 | 대나무 숲 미스터리: 근접 장면의 긴장감 | 일본어 애니메이션 예고: 외형과 표정 제어 |
|---|---|---|
...
| 일상 영상과 불가능한 사건의 불일치 | 수영: 네 가지 동작 구분 | 절벽 추격: 끊기지 않는 카메라 이동 |
|---|---|---|
...
| 움직이는 글자로 명언을 이야기로 | 게임 화면: 턴 진행을 명확하게 | 움직이는 포스터: 구도를 유지하며 조립 |
|---|---|---|
...
| 박자에 맞춘 서부극 타이틀 | 서스펜스: 대사·반응·소리의 반전 | 길거리 음식: 장소·조리·시식 |
|---|---|---|
